...
if (typeof window !== "undefined") {
  window.addEventListener("load", () => {
    ...
    script.onload = () => {
      ...
      if (!document.querySelector('script[data-fts-print-billing-v47-final]')) {
        const finalFix = document.createElement("script");
        finalFix.src = "./print-billing-v47-final.js?v=47";
        finalFix.async = true;
        finalFix.dataset.ftsPrintBillingV47Final = "1";
