self.FTS_CONFIG = {
  ...
  cacheVersion: "fts-selfie-v55-print-event-window"
};
...
function ftsResetGuestWorkerV53(){
  ...
  try{
    const key="fts_guest_sw_reset_v55";if(sessionStorage.getItem(key)==="1")return;sessionStorage.setItem(key,"1");
    Promise.resolve().then(async()=>{
      ...
      const u=new URL(location.href);u.searchParams.set("fts_boot","55");u.searchParams.set("v",String(Date.now()));location.replace(u.toString());
    });
  }catch{}
}
...
function ftsLoadGuestRuntimeV53(){
  let tries=0;const timer=setInterval(()=>{
    ...
    ftsLoadScriptOnce("./print-billing-guest-v54.js?v=55","data-fts-print-billing-guest-v55",()=>{
      ftsLoadScriptOnce("./guest-runtime-v52.js?v=55","data-fts-guest-runtime-v52");
    });
  },100);
}
  ...
  if(page==="index.html"){
    ...
    window.addEventListener("load",()=>{
      if(page==="admin.html"||page==="print.html"){
        ftsLoadScriptOnce("./print-billing-v47.js?v=55","data-fts-print-billing-v47",()=>{if(page==="print.html")ftsLoadScriptOnce("./print-billing-v47-fix.js?v=55","data-fts-print-billing-v47-fix");ftsApplyPrintBillingV47Polish(page)});
      }
      if(page==="admin.html"){
        ftsLoadScriptOnce("./gallery-links-v48.js?v=55","data-fts-gallery-links-v48",()=>ftsLoadScriptOnce("./admin-social-v52.js?v=55","data-fts-admin-social-v52"));
      }
      if(page==="dashboard.html"){
        ftsLoadScriptOnce("./dashboard-stats-v49.js?v=55","data-fts-dashboard-stats-v49",()=>ftsLoadScriptOnce("./dashboard-stats-v52.js?v=55","data-fts-dashboard-stats-v52"));
      }
    });
  }
}
