...
const CACHE='fts-selfie-production-v76-adaptive-photo-20260923';
const CORE=['./','./index.html','./dashboard.html','./studio.html','./print.html','./config.js','./social-share.js','./printer-staff-v72.js','./fts-photo-engine.js','./camera-live.js','./print-pickup-guest-v57.js','./print-pickup-station-v57.js','./manifest.webmanifest','./dashboard.webmanifest','./print.webmanifest','./offline.html','./icon-192.png','./icon-512.png'];
