...
rm -f "$DIST/FTS-Printer-macOS-v0.2.6-printer-autosync.zip" "$DIST/FTS-Printer-macOS-v0.2.6-printer-autosync.dmg"
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/FTS-Printer-macOS-v0.2.6-printer-autosync.zip"
DMG="$DIST/FTS-Printer-macOS-v0.2.6-printer-autosync.dmg"
rm -f "$DMG"
