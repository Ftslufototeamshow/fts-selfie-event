...
rm -f "$DIST/FTS-Printer-macOS-v0.2.5-login-recovery.zip" "$DIST/FTS-Printer-macOS-v0.2.5-login-recovery.dmg"
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/FTS-Printer-macOS-v0.2.5-login-recovery.zip"
DMG="$DIST/FTS-Printer-macOS-v0.2.5-login-recovery.dmg"
rm -f "$DMG"
