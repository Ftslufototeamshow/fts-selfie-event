...
rm -f "$DIST/FTS-Printer-macOS-v0.3.12-media-workflow.zip" "$DIST/FTS-Printer-macOS-v0.3.12-media-workflow.dmg"
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/FTS-Printer-macOS-v0.3.12-media-workflow.zip"
DMG="$DIST/FTS-Printer-macOS-v0.3.12-media-workflow.dmg"
rm -f "$DMG"
