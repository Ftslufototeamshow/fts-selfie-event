...
rm -f "$DIST/FTS-Printer-macOS-v0.3.11-finder-cards.zip" "$DIST/FTS-Printer-macOS-v0.3.11-finder-cards.dmg"
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/FTS-Printer-macOS-v0.3.11-finder-cards.zip"
DMG="$DIST/FTS-Printer-macOS-v0.3.11-finder-cards.dmg"
rm -f "$DMG"
