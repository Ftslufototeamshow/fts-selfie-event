...
rm -f "$DIST/FTS-Printer-macOS-v0.3.6-orientation.zip" "$DIST/FTS-Printer-macOS-v0.3.6-orientation.dmg"
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/FTS-Printer-macOS-v0.3.6-orientation.zip"
DMG="$DIST/FTS-Printer-macOS-v0.3.6-orientation.dmg"
rm -f "$DMG"
