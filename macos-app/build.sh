...
rm -f "$DIST/FTS-Printer-macOS-v0.2.9-spooler.zip" "$DIST/FTS-Printer-macOS-v0.2.9-spooler.dmg"
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/FTS-Printer-macOS-v0.2.9-spooler.zip"
DMG="$DIST/FTS-Printer-macOS-v0.2.9-spooler.dmg"
rm -f "$DMG"
