...
rm -f "$DIST/FTS-Printer-macOS-v0.3.22-fast-sd-auto-dispatch.zip" "$DIST/FTS-Printer-macOS-v0.3.22-fast-sd-auto-dispatch.dmg"
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/FTS-Printer-macOS-v0.3.22-fast-sd-auto-dispatch.zip"
DMG="$DIST/FTS-Printer-macOS-v0.3.22-fast-sd-auto-dispatch.dmg"
rm -f "$DMG"
