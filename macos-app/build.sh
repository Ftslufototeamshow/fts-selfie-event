...
rm -f "$DIST/FTS-Printer-macOS-v0.3.5-wlan-cards.zip" "$DIST/FTS-Printer-macOS-v0.3.5-wlan-cards.dmg"
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/FTS-Printer-macOS-v0.3.5-wlan-cards.zip"
DMG="$DIST/FTS-Printer-macOS-v0.3.5-wlan-cards.dmg"
rm -f "$DMG"
