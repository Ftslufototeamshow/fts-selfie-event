...
rm -f "$DIST/FTS-Printer-macOS-v0.3.9-card-readonly.zip" "$DIST/FTS-Printer-macOS-v0.3.9-card-readonly.dmg"
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/FTS-Printer-macOS-v0.3.9-card-readonly.zip"
DMG="$DIST/FTS-Printer-macOS-v0.3.9-card-readonly.dmg"
rm -f "$DMG"
