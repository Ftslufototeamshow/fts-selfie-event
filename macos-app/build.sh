...
rm -f "$DIST/FTS-Printer-macOS-v0.3.3-paper-profile.zip" "$DIST/FTS-Printer-macOS-v0.3.3-paper-profile.dmg"
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/FTS-Printer-macOS-v0.3.3-paper-profile.zip"
DMG="$DIST/FTS-Printer-macOS-v0.3.3-paper-profile.dmg"
rm -f "$DMG"
