...
rm -f "$DIST/FTS-Printer-macOS-v0.3.1-native-print.zip" "$DIST/FTS-Printer-macOS-v0.3.1-native-print.dmg"
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/FTS-Printer-macOS-v0.3.1-native-print.zip"
DMG="$DIST/FTS-Printer-macOS-v0.3.1-native-print.dmg"
rm -f "$DMG"
