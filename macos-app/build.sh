...
rm -f "$DIST/FTS-Printer-macOS-v0.3.10-usb-update-portrait.zip" "$DIST/FTS-Printer-macOS-v0.3.10-usb-update-portrait.dmg"
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/FTS-Printer-macOS-v0.3.10-usb-update-portrait.zip"
DMG="$DIST/FTS-Printer-macOS-v0.3.10-usb-update-portrait.dmg"
rm -f "$DMG"
