...
rm -f "$DIST/FTS-Printer-macOS-v0.3.0-diagnostics.zip" "$DIST/FTS-Printer-macOS-v0.3.0-diagnostics.dmg"
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/FTS-Printer-macOS-v0.3.0-diagnostics.zip"
DMG="$DIST/FTS-Printer-macOS-v0.3.0-diagnostics.dmg"
rm -f "$DMG"
