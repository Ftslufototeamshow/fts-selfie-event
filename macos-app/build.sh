...
rm -f "$DIST/FTS-Printer-macOS-v0.3.19-manual-sd-recovery.zip" "$DIST/FTS-Printer-macOS-v0.3.19-manual-sd-recovery.dmg"
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/FTS-Printer-macOS-v0.3.19-manual-sd-recovery.zip"
DMG="$DIST/FTS-Printer-macOS-v0.3.19-manual-sd-recovery.dmg"
rm -f "$DMG"
