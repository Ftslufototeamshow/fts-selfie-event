...
rm -f "$DIST/FTS-Printer-macOS-v0.3.4-fullbleed.zip" "$DIST/FTS-Printer-macOS-v0.3.4-fullbleed.dmg"
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/FTS-Printer-macOS-v0.3.4-fullbleed.zip"
DMG="$DIST/FTS-Printer-macOS-v0.3.4-fullbleed.dmg"
rm -f "$DMG"
