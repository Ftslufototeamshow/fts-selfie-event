...
rm -f "$DIST/FTS-Printer-macOS-v0.3.29-border-safearea-fix.zip" "$DIST/FTS-Printer-macOS-v0.3.29-border-safearea-fix.dmg"
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/FTS-Printer-macOS-v0.3.29-border-safearea-fix.zip"
DMG="$DIST/FTS-Printer-macOS-v0.3.29-border-safearea-fix.dmg"
rm -f "$DMG"
