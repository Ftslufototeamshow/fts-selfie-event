...
rm -f "$DIST/FTS-Printer-macOS-v0.3.25-macos-printer-names.zip" "$DIST/FTS-Printer-macOS-v0.3.25-macos-printer-names.dmg"
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/FTS-Printer-macOS-v0.3.25-macos-printer-names.zip"
DMG="$DIST/FTS-Printer-macOS-v0.3.25-macos-printer-names.dmg"
rm -f "$DMG"
