...
rm -f "$DIST/FTS-Printer-macOS-v0.2.4-printer-wakeup.zip" "$DIST/FTS-Printer-macOS-v0.2.4-printer-wakeup.dmg"
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/FTS-Printer-macOS-v0.2.4-printer-wakeup.zip"
DMG="$DIST/FTS-Printer-macOS-v0.2.4-printer-wakeup.dmg"
rm -f "$DMG"
